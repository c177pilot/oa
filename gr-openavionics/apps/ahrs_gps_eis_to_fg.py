...
# Generated: Sun Jul  7 08:59:34 2013
##################################################
...
class ahrs_gps_eis_to_fg(grc_wxgui.top_block_gui):
	...
	def __init__(self):
		...
		# Blocks
		##################################################
		self.openavionics_serial_io_0_0_0 = openavionics.serial_io("/dev/pts/18",0,19200,0,1,False)
		self.openavionics_serial_io_0_0 = openavionics.serial_io("/dev/pts/16",0,19200,0,1,False)
		self.openavionics_serial_io_0 = openavionics.serial_io("/dev/pts/6",0,19200,0,1,False)
