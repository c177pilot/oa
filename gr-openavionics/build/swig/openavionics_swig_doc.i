...
%feature("docstring") gr::openavionics::square_ff "<+description of block+>"

%feature("docstring") gr::openavionics::square_ff::make "Return a shared_ptr to a new instance of openavionics::square_ff.

To avoid accidental use of raw pointers, openavionics::square_ff's constructor is in a private implementation class. openavionics::square_ff::make is the public interface for creating new instances.
